...
def firewall_one_connect(primary_firewall , secondary_firewall) :
    ...
    firewall_one_identity = firewall_one.path ( '/ip/ipsec/identity' )
    firewall_two_identity = firewall_two.path ( '/ip/ipsec/identity' )
    ...
    # Identity
    with open ( 'firewall_one_ipsec_identity.txt' , 'w+' ) as fw_file :
        for imte in firewall_one_identity :
    ...
    with open ( 'firewall_two_ipsec_identity.txt' , 'w+' ) as fw2_file :
        for item in firewall_two_identity :
